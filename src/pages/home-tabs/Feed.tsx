...
function Feed() {
  ...
  const houseworkTasks = [
    ...
    { task: 'Iron clothes - Only uniforms and formal wear', color: '#B0E0E6' },
    ...
    { task: 'Clean the fridge - Once a month', color: '#20B2AA' },
    { task: 'Dust shelves - Twice a week', color: '#FFD700' },
    { task: 'Disinfect doorknobs and switches - Daily', color: '#90EE90' },
